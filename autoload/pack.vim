...
" eg: git clone --quiet --depth 4 https://github.com/vim-airline/vim-airline.git vim/pack/shapeshed/start/vim-airline
let s:start_plugs = []
...
" Prepare plugin install commands
" eg: git clone --quiet --depth 4 https://github.com/vim-airline/vim-airline.git vim/pack/shapeshed/opt/vim-airline
let s:opt_plugs = []
...
" Install plugins in folder start
